 ...
 * Size: 112 px
 * Bpp: 4
 * Opts: --font C:/Users/shelb/Documents/Arduino/libraries/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 112 --bpp 4 --format lvgl --no-compress --lv-include lvgl.h --lv-font-name font_clock_112 -r 0x2D-0x3A -o ../ui/font_clock_112.c
 ******************************************************************************/
...
#ifndef FONT_CLOCK_112
#define FONT_CLOCK_112 1
#endif
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x2, 0x88, 0x88, 0x88, 0x88, 0x83,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 686, .box_w = 31, .box_h = 10, .ofs_x = 6, .ofs_y = 26},
    {.bitmap_index = 155, .adv_w = 407, .box_w = 16, .box_h = 16, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 283, .adv_w = 631, .box_w = 48, .box_h = 106, .ofs_x = -4, .ofs_y = -11},
    {.bitmap_index = 2827, .adv_w = 1195, .box_w = 65, .box_h = 81, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 5460, .adv_w = 663, .box_w = 30, .box_h = 79, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 6645, .adv_w = 1029, .box_w = 60, .box_h = 79, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 9015, .adv_w = 1025, .box_w = 60, .box_h = 80, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 11415, .adv_w = 1199, .box_w = 70, .box_h = 79, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 14180, .adv_w = 1029, .box_w = 60, .box_h = 80, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 16580, .adv_w = 1106, .box_w = 62, .box_h = 81, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 19091, .adv_w = 1072, .box_w = 60, .box_h = 79, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 21461, .adv_w = 1154, .box_w = 64, .box_h = 81, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 24053, .adv_w = 1106, .box_w = 61, .box_h = 81, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 26524, .adv_w = 407, .box_w = 16, .box_h = 61, .ofs_x = 5, .ofs_y = -1}
};
...
static const int8_t kern_class_values[] =
{
    4, -8, 0, 8, -22, -16, -24, 8,
    0, -12, 0, 0, 0, -8, 0, 118,
    -14, -16, 12, 12, -11, 0, -16, 12,
    0, 0, -81, -116, -81, -24, 36, 0,
    0, -80, 0, 14, -27, 0, -18, 8,
    -14, -24, 0, -4, -4, -12, 0, 0,
    -8, 0, 0, 0, -8, 12, 12, -4,
    0, 0, 0, -23, 0, -4, 0, 0,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_clock_112 = {
#else
lv_font_t font_clock_112 = {
#endif
